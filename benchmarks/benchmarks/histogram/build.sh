...
sudo time pmcstat -d -w 1 -p l1d_tlb_rd -p l2d_tlb_rd -p l1d_tlb_refill -p cpu_cycles -p dtlb_walk -p stall_backend -p ll_cache_miss_rd -o histogram-small.txt ./histogram-pthread.out histogram_datafiles/small.bmp > histogram-small-out-txt
...
sudo time pmcstat -d -w 1 -p l1d_tlb_rd -p l2d_tlb_rd -p l1d_tlb_refill -p cpu_cycles -p dtlb_walk -p stall_backend -p ll_cache_miss_rd -o histogram-med.txt ./histogram-pthread.out histogram_datafiles/med.bmp > histogram-med-out-txt
...
sudo time pmcstat -d -w 1 -p l1d_tlb_rd -p l2d_tlb_rd -p l1d_tlb_refill -p cpu_cycles -p dtlb_walk -p stall_backend -p ll_cache_miss_rd -o histogram-large.txt ./histogram-pthread.out histogram_datafiles/large.bmp > histogram-large-out-txt
